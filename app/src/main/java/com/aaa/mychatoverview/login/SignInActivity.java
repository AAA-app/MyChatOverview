package com.aaa.mychatoverview.login;
...
import com.aaa.mychatoverview.activities.UserListActivity;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repeatPasswordEditText = findViewById(R.id.repeatPassword_editText);
        nameEditText = findViewById(R.id.name_editText);
        toggleLoginSignUpTextView = findViewById(R.id.toggleLoginSingUP_TextView);
        loginSignUpButton = findViewById(R.id.login_singUpBtn);
